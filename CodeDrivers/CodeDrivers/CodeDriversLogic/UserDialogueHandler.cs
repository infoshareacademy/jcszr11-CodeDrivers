    ...
    public class Menu_tekstowe
    {
        ...
        void AddReservation()
        {
            ...
            while (true)
            {
                ...
                while (true)
                {
                    reservationEndDate = DataHandler.GetDate("Podaj datę końca rezerwacji");
                    ...
                    while (true)
                    {
                        ...
                        while (true)
                        {
                            ...
                            {
                                newUser.AddUser();
                                Car carToRent = availableCar[chosenCarId];
                                carRepository.RentCar(carToRent);
                            }
